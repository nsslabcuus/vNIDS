...
class FlowEntryParser:
    def __init__(self, filename):
        ...
        self.must_field = ("name", "switch", "priority", "cookie", "active")
        self.optional_field = ("eth_dst", "eth_src", "input", "eth_type", "eth_vlan_vid", "instruction_apply_actions","actions","ip_proto" )
