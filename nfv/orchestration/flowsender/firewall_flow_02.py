...
command="ovs-ofctl show ovs-lan|grep `xl list|grep 'firewall_02'|awk '{print $2}'`'.0'|cut -d '(' -f1";
trafficPort=subprocess.check_output(command, shell=True);
command="ovs-ofctl show ovs-lan|grep `xl list|grep 'firewall_02'|awk '{print $2}'`'.2'|cut -d '(' -f1";
...
flow1 = {
    ...
    "actions":"pop_vlan,set_field=eth_dst->00:00:00:00:02:00,output="+trafficPort
}
...
flow3 = {
    ...
    "cookie":"17", 
    # from localhost to clickos 
    "eth_src":"74:a0:2f:5f:17:e4", "eth_dst":"00:00:00:00:02:02", 
    "active":"true",
...
flow4 = {
    ...
    "cookie":"4", 
    # from clickos to server 
    "eth_src":"00:00:00:00:02:00", "eth_dst":"a0:ec:f9:e8:a4:72", 
    "active":"true",
    "actions":"output=2"
}
...
flow5 = {
    ...
    "cookie":"5", 
    # from clickos to client 
    "eth_src":"00:00:00:00:02:00", "eth_dst":"a0:ec:f9:e8:ac:69", 
    "active":"true",
    "actions":"output=1"
}
