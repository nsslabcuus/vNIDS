...
while [[ $index -lt $count ]]; do 
    ...
    echo "1,p_delete,10.130.127."$index"1/32,10.130.127.2/32,1/65535,1/65535,tcp,allow,00:00:00:00:02:02"
    # Allow server to client.
    echo "1,p_delete,10.130.127.2/32,10.130.127."$index"1/32,1/65535,1/65535,tcp,allow,00:00:00:00:02:02"
done
