...
if [[ -z $3 ]]; then 
    ...
    echo "E.g., $0 1 0 2 --> means 0 dummy rules and 2 real rules."
    exit 1
fi

python pymainsender.py file "../tcp/init_rule_tcp_dummy_"$1"_"$2".cfg" 1
python pymainsender.py file "../tcp/init_rule_tcp_real_"$1"_"$3".cfg" 1
