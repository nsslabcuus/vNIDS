...
#define ETHERTYPE_GRID                                                      \
  0x7fff /* wvlan_cs driver won't transmit frames with high bit of protocol \
            number set */
...
/* define structure of Neighborhood Advertisement Message -reply to multicast
 * neighborhood solitation message */
struct click_nd_adv {
  uint8_t type;
  uint8_t code;
  uint16_t checksum;
...
/* define structure of Neighborhood Advertisement Message - reply to unicast
 * neighborhood solitation message */
